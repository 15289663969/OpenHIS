...
class __TwigTemplate_8518400746cf55493e61a380ddccc8a9d71941cda61b6a261c3dd621873dd58a extends Twig_Template
{
...
<table id=\"table_columns\" class=\"noclick\">
    ...
    ";
        ...
        if (((isset($context["server_type"]) ? $context["server_type"] : null) == "MariaDB")) {
            // line 100
            echo "        ";
            $context["options"] = twig_array_merge((isset($context["options"]) ? $context["options"] : null), ["PERSISTENT" => "PERSISTENT"]);
            // line 101
            echo "    ";
        } else {
            // line 102
            echo "        ";
            $context["options"] = twig_array_merge((isset($context["options"]) ? $context["options"] : null), ["STORED" => "STORED"]);
            // line 103
            echo "    ";
        }
        // line 104
...
";
    ...
    {
        return new Twig_Source("", "columns_definitions/table_fields_definitions.twig", "D:\\phpstudy_pro\\WWW\\OpenHIS\\phpMyAdmin4.8.5\\templates\\columns_definitions\\table_fields_definitions.twig");
    }
}
