...
class __TwigTemplate_1f5366057cf0e0cde206082a89651df1a190f52b466012467b87bb87f243cde4 extends Twig_Template
{
...
(isset($context["sort_order_text"]) ? $context["sort_order_text"] : null))) : (""));
        ...
        foreach ($context['_seq'] as $context["stat_name"] => $context["stat"]) {
            if (twig_in_filter($context["stat_name"], twig_get_array_keys_filter((isset($context["first_database"]) ? $context["first_database"] : null)))) {
                // line 16
                echo "            ";
                $context["url_params"] = twig_array_merge((isset($context["url_params"]) ? $context["url_params"] : null), ["sort_by" =>                 // line 17
...
";
    ...
    {
        return new Twig_Source("", "server/databases/table_header.twig", "D:\\phpstudy_pro\\WWW\\OpenHIS\\phpMyAdmin4.8.5\\templates\\server\\databases\\table_header.twig");
    }
}
