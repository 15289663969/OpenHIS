...
class __TwigTemplate_7ae83f628d2076979ddacb15564608c14d49e6a92e9c2112358582997d24c751 extends Twig_Template
{
...
(isset($context["column_meta"]) ? $context["column_meta"] : null), "column_status", [], "array"), "isEditable", [], "array"))) {
    ...
    value=\"";
        // line 30
        echo twig_escape_filter($this->env, (($this->getAttribute((isset($context["column_meta"]) ? $context["column_meta"] : null), "Field", [], "array", true, true)) ? ($this->getAttribute((isset($context["column_meta"]) ? $context["column_meta"] : null), "Field", [], "array")) : ("")), "html", null, true);
        echo "\" />
...
";
    ...
    {
        return new Twig_Source("", "columns_definitions/column_name.twig", "D:\\phpstudy_pro\\WWW\\OpenHIS\\phpMyAdmin4.8.5\\templates\\columns_definitions\\column_name.twig");
    }
}
