...
class __TwigTemplate_74ae69ff3e0f6b927ddf8faff062375d2b1d545a660202d2cd946495329aa8d6 extends Twig_Template
{
    ...
    <table class=\"data_full_width\" id=\"plugins-";
        // line 3
        echo twig_escape_filter($this->env, preg_replace("/[^a-z]/", "", twig_lower_filter($this->env, (isset($context["plugin_type"]) ? $context["plugin_type"] : null))), "html", null, true);
        echo "\">
        <caption class=\"tblHeaders\">
            ";
        // line 5
        echo twig_escape_filter($this->env, (isset($context["plugin_type"]) ? $context["plugin_type"] : null), "html", null, true);
        echo "
        </caption>
        <thead>
            <tr>
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["plugin_list"]) ? $context["plugin_list"] : null));
...
";
    ...
    {
        return new Twig_Source("", "server/plugins/section.twig", "D:\\phpstudy_pro\\WWW\\OpenHIS\\phpMyAdmin4.8.5\\templates\\server\\plugins\\section.twig");
    }
}
