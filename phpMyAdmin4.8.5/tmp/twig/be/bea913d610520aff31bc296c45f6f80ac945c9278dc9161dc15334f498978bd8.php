...
class __TwigTemplate_56c28ec7b603565500cc3df6c422cb473c5588d170dc8aed879295309998b923 extends Twig_Template
{
...
";
        ...
        // line 13
        if ($this->getAttribute((isset($context["column_meta"]) ? $context["column_meta"] : null), "DefaultValue", [], "array", true, true)) {
            // line 14
            echo "    ";
            $context["default_value"] = $this->getAttribute((isset($context["column_meta"]) ? $context["column_meta"] : null), "DefaultValue", [], "array");
        }
        // line 16
        if (((isset($context["type_upper"]) ? $context["type_upper"] : null) == "BIT")) {
            // line 17
            echo "    ";
            $context["default_value"] = PhpMyAdmin\Util::convertBitDefaultValue($this->getAttribute((isset($context["column_meta"]) ? $context["column_meta"] : null), "DefaultValue", [], "array"));
        } elseif (((        // line 18
(isset($context["type_upper"]) ? $context["type_upper"] : null) == "BINARY") || ((isset($context["type_upper"]) ? $context["type_upper"] : null) == "VARBINARY"))) {
            // line 19
            echo "    ";
            $context["default_value"] = bin2hex($this->getAttribute((isset($context["column_meta"]) ? $context["column_meta"] : null), "DefaultValue", [], "array"));
        }
        // line 21
        echo "
<select name=\"field_default_type[";
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["key"] => $context["value"]) {
            ...
            echo "\"";
            // line 27
            if (($this->getAttribute((isset($context["column_meta"]) ? $context["column_meta"] : null), "DefaultType", [], "array", true, true) && ($this->getAttribute(            // line 28
(isset($context["column_meta"]) ? $context["column_meta"] : null), "DefaultType", [], "array") == $context["key"]))) {
                // line 29
...
";
    ...
    {
        return new Twig_Source("", "columns_definitions/column_default.twig", "D:\\phpstudy_pro\\WWW\\OpenHIS\\phpMyAdmin4.8.5\\templates\\columns_definitions\\column_default.twig");
    }
}
