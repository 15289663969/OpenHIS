    ...
    <div class="container-fluid">
        <div class="panel clearfix pd10 mb20">
            <div class="fublBox mr10"><span>收费类型：</span>
                <select class="form-control form-itmeB" name="type_id">
        ...
        <div class="row mb20">
            <div class="col-md-2 ftc flh64">
                <div class="yelloBg pd10 white">
                    <div class="height64 generalincome">0</div>
                ...
                <div class="">
                    <div class="blueBg2 clearfix pdrl10 m_h70">
                        ...
                        <div class="flh34 l mr60">
                            <div class="chargeincome">0</div>
                            <div class="bwt">收费金额</div>
                        </div>
                        <div class="flh34 l mr60">
                            <div class="refundincome">0</div>
                    ...
                    <div class="greenBg clearfix pdrl10 m_h70 mt8">
                        ...
                        <div class="flh34 l mr60">
                            <div class="cashincome">0</div>
                            <div class="bwt">现金收入</div>
                        </div>
                        <div class="flh34 l mr60">
                            <div class="wechartincome">0</div>
                            <div class="bwt">微信收入</div>
                        </div>
                        <div class="flh34 l mr60">
                            <div class="alipayincome">0</div>
                            <div class="bwt">支付宝收入</div>
                        </div>
                        <div class="flh34 l mr60">
                            <div class="cashrefund">0</div>
                            <div class="bwt">现金退款</div>
                        </div>
                        <div class="flh34 l mr60">
                            <div class="wechartrefund">0</div>
                            <div class="bwt">微信退款</div>
                        </div>
                        <div class="flh34 l mr60">
                            <div class="alipayrefund">0</div>
...
<!-- END MAIN CONTENT -->
<script src="/Public/his/js/echarts.min.js?<?php echo time();?>"></script>
<script>
    var d = new Date();
    ...
    $(function () {
        ...
        var type_id = '', status = '', starttime = '', endtime = '';
        //选项卡切换
        ...
        getIncomeList(_incomestat_page, _pagesize, type_id, status, starttime, endtime);
        getIncomeInfo(type_id, status, starttime, endtime);

        //获取统计信息
        function getIncomeInfo(type_id, status, starttime, endtime) {
        ...
        //获取列表信息
        function getIncomeList(page, pagesize, type_id, status, starttime, endtime) {
        ...
        $(document).on("click", '.search', function () {
            type_id = $("select[name='type_id'] option:selected").val();
            status = $("select[name=status] option:selected").val();
            starttime = $("input[name='starttime']").val();
            endtime = $("input[name='endtime']").val();
            if (type_id || status || starttime || endtime) {
                _incomestat_page = 1;
            }
            getIncomeList(_incomestat_page, _pagesize, type_id, status, starttime, endtime);
            getIncomeInfo(type_id, status, starttime, endtime);
