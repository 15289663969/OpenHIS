    ...
    <div class="main-content">
        <div class="container-fluid">
            <div class="pd10 panel mb20">
                <div class="fublBox mr10"><span>费用名称：</span>
...
<div class="bombBox" id="editchrgeBomb" style="display: none;">
    <div class="bombContent editchrgeBomb whiteBg">
        <div class="bombTit">编辑处方附加费<i class="fa fa-remove"></i></div>
        <div class="ftc pd10">
            <div class="input-group listSeaForm wb100">
				<span class="input-group-btn">
					<span class="btn">费用名称：</span>
    ...
    $(function() {
        ...
        $(document).on('click', '.add', function(){
            ...
            $.post("<?php echo U('/PrescriptionExtracharges/addExtraCharges');?>",
                {"extracharges_name":extracharges_name,"fee":fee,"type":type},
                function (data) {
        ...
        $(document).on('click', '.edit', function(){
            ...
            $.post("<?php echo U('/PrescriptionExtracharges/editExtraCharges');?>",
                {"extracharges_name":extracharges_name,"fee":fee,"type":type,'pre_id':pre_id},
                function (data) {
                    if (data.status=='success') {
